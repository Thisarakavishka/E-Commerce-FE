        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-800">
            {!success ? (
              ...
              <div className="text-center py-6">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-white flex items-center gap-1 mx-auto"
                >
            ...
            <div className="mt-6 text-center">
              <Link
                to="/customer/login"
                className="text-gray-400 hover:text-white transition-colors flex items-center gap-1 justify-center"
              >
