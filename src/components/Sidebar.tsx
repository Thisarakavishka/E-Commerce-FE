...
const Sidebar = () => {
  ...
  const communicationLinks: NavLinkType[] = [
    { icon: Bell, text: "Notifications", link: "/admin/notifications", badge: unreadCount },
  ]
          ...
          return (
            <li key={index}>
              ...
              >
                ...
                {(!collapsed || (isMobile && mobileOpen)) && item.badge && item.badge > 0 && (
